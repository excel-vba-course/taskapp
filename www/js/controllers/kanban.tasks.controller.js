...
var KanboardTasksController = function($ionicLoading, $scope, $ionicActionSheet, 
  ...
  taskModule.controller('KanboardTasksController', ['$ionicLoading', '$scope',  '$ionicActionSheet', '$q', '$http', '$window', '$base64', '$stateParams', '$state', '$interpolate', '$filter', KanboardTasksController]);
